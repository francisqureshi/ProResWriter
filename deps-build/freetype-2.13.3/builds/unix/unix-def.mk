...
MKINSTALLDIRS   := /opt/homebrew/bin/gmkdir -p
...
#
prefix       := /Users/mac10/Projects/ProResWriter/deps-build/install
exec_prefix  := ${prefix}
...
PKGCONFIG_REQUIRES         :=  zlib, bzip2, libpng, harfbuzz >= 2.0.0
PKGCONFIG_REQUIRES_PRIVATE := 
PKGCONFIG_LIBS             := -L${libdir} -lfreetype 
PKGCONFIG_LIBS_PRIVATE     := 
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/Users/mac10/Projects/ProResWriter/deps-build/install/lib -lpng16 -lz -L/Users/mac10/Projects/ProResWriter/deps-build/install/lib -lharfbuzz -lm -lfreetype -lbz2 -lpng16 -lz -L/opt/homebrew/Cellar/brotli/1.1.0/lib -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.2.20
