...
////  ProResWriter
////
////  Created by Francis Qureshi on 14/08/2025.
////  Contains unused/deprecated functions moved from main.swift
////
//
//import AVFoundation
//import Foundation
//
//// MARK: - Deprecated Test Functions
//
...
//}
//
//// MARK: - Deprecated Frame Processing Functions (Not used by runComposition)
//
//// These functions were used for frame-by-frame processing approach
//// runComposition() now uses AVMutableComposition with passthrough export
//
...
//}
//
//// MARK: - Deprecated Asset Writer Functions (Not used by streamlined runComposition)
//
//// These functions were used for manual asset writing approach
//// runComposition() now uses AVMutableComposition + AVAssetExportSession passthrough
//
//private func setupAssetWriter(
//    outputURL: URL, properties: VideoProperties, proResType: AVVideoCodecType
//) throws {
//    // This function is no longer used - replaced by AVAssetExportSession
//}
//
...
//    duration: Double
//) -> AVAssetWriterInput? {
//    // This function is no longer used - timecode handled by composition
//    return nil
//}
//
...
//) async throws {
//    // This entire function is no longer used - replaced by passthrough export
//}
//
...
//) async throws {
//    // This entire function is no longer used - no frame-by-frame processing
//}
//
//private func prepareSegmentReaders(_ segments: [GradedSegment]) async throws -> [URL: AVAssetReader] {
//    // This function is no longer used - no asset readers needed
//    return [:]
//}
//
//private func findActiveSegment(at time: CMTime, in segments: [GradedSegment]) -> GradedSegment? {
//    // This function is no longer used - composition handles timing
//    return nil
//}
//
...
//    // This function is no longer used - no frame extraction needed
//    return nil
//}
//
...
//    duration: CMTime
//) async throws {
//    // This function is no longer used - timecode copied from base asset
//}
//
//private func createTimecodeSampleBuffer(timecode: String, frameRate: Int32, duration: Double) -> CMSampleBuffer? {
//    // This function is no longer used - no manual timecode creation
//    return nil
//}
//
...
//) async throws {
//    // This function is no longer used - timecode preserved in composition
//}
//
//
//
