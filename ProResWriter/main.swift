...
func runComposition() async {
    ...
    let blankRushURL = URL(
        fileURLWithPath:
            "/Users/fq/Movies/ProResWriter/9999 - COS AW ProResWriter/08_GRADE/02_GRADED CLIPS/03 INTERMEDIATE/blankRiush/resolve_COS AW25_4K_4444_24FPS_LR001_LOG_blankRush.mov"
    )
