...
public class SMPTE {
    ...
    public init(fps: Double, dropFrame: Bool = false) {
        self.fps = fps
        self.df = dropFrame
    }
    ...
    public func getFrames(tc: String) throws -> Int {
    ...
    public func getTC(frames: Int) -> String {
...
public enum SMPTEError: Error, LocalizedError {
...
extension SMPTE {
    ...
    public func addFrames(to timecode: String, frames: Int) throws -> String {
    ...
    /// - Throws: SMPTEError if invalid
    public func frameDifference(from startTC: String, to endTC: String) throws -> Int {
    ...
    public func isValidTimecode(_ timecode: String) -> Bool {
        do {
